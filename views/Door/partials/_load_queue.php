...
<div class="panel panel-warning">
    <div class="panel-heading">
        <h3 class="panel-title">
            ...
            <?php echo __('list_card_for_load', array(':count' => isset($people_add) ? count($people_add) : 0)); ?>
            
            <span class="pull-right">
                <span class="badge" style="background-color: #f0ad4e; margin-right: 10px;">
                    <?php echo isset($people_add) ? count($people_add) : 0; ?>
                </span>
    ...
    <div class="panel-body">
        <?php if (isset($people_add) && !empty($people_add)): ?>
            <div class="table-responsive">
                <table id="table1" class="table table-striped table-hover table-condensed table-bordered tablesorter">
                    <thead>
                        <tr>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <small class="text-muted">
                                            ...
                                            <?php echo __('Всего записей') . ': ' . count($people_add); ?>
                                        </small>
                                    </div>
        ...
        <?php else: ?>
            <div class="alert alert-info" style="margin: 0;">
                ...
                <?php echo __('Нет карт для загрузки'); ?>
            </div>
        <?php endif; ?>
    </div>
</div>
